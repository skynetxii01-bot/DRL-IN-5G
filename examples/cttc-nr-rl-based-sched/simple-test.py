...
if __name__ == "__main__":
  ...
  parser.add_argument("--priorityTrafficScenario", type=int, default=0, help="The traffic scenario for the case of priority. Can be 0: saturation or 1: medium-load")
  parser.add_argument("--numTrafficProfile", type=int, default=3, help="Number of traffic profiles")
