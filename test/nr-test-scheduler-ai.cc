...
class NrTestSchedulerAiCase : public TestCase
{
  public:
    using FlowProfileList =
        std::list<std::pair<uint8_t, LogicalChannelConfigListElement_s::QosBearerType_e>>;
...
NrTestSchedulerAiCase::DoRun()
{
    ...
    for (auto& pair : m_epsBearerMap)
    {
        ...
        lc.m_qosBearerType = static_cast<LogicalChannelConfigListElement_s::QosBearerType_e>(
